...
if [[ -x `which -p keychain` ]]; then
	...
	if [[ `uname -n` == nienor || `uname -n` == stephen-hawking ]]; then
		...
		eval `keychain --eval --timeout 960 id_rsa` # + GPG key
	else
...
if [ -f ~/.mix/escripts ]; then
    PATH='$PATH:/home/pygospa/.mix/escripts'
fi



# TODO Besser einsortieren
source /usr/share/fzf/key-bindings.zsh
source /usr/share/fzf/completion.zsh

PATH="/home/pygospa/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/pygospa/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/pygospa/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/pygospa/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/pygospa/perl5"; export PERL_MM_OPT;
