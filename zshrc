...
#
#
# <----------------- from the GRML live CD, by Michael Prokop ----------------->
...
# completion system
if zrcautoload compinit -u; then
...
# REALY NEAT functions that will open the right BitBucket or GitHub
# repositories regarding your current path.
#
# This is the OS X variant. For other *nix systems, please replace the 'open
# $URL' part to '/path/to/browser $URL', or if your system uses a $BROWSER
# variable, use that instead of the path: '$BROWSER $URL'. If you have
# installed and configured xdg-open - which is the pendant to open - you can
# also use that.
